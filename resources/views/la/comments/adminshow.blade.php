...
<div id="page-content" class="profile2">
		...
		<div class="col-md-4">
			<div class="row">
				<div class="col-md-3">
					...
					<div class="profile-icon text-primary"><i class="fa"></i></div>
				</div>
				<div class="col-md-9">
					<h4 class="name"></h4>
					<div class="row stats">
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/articles') }}" data-toggle="tooltip" data-placement="right" title="Back to Articles"><i class="fa fa-chevron-left"></i></a></li>
		<li class="active"><a role="tab" data-toggle="tab" class="active" href="#tab-general-info" data-target="#tab-info"><i class="fa fa-bars"></i> Comments</a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					<div class="panel-default panel-heading">
						<h4>Comments on This Article</h4>
					</div>
						...
						?>
							...
							<div class="row">
							            <div class="col-md-12">
							               ...
							               <div class="panel-heading">
							                  ...
							                  <!--<div class="panel-title pull-right"><button class="btn btn-primary">Reply</button></div>
							...
							<ul class="pagination">
							    <li class="{{ ($comment->currentPage() == 1) ? ' disabled' : '' }}">
							        <a href="{{ $comment->url(1) }}">Previous</a>
							    </li>
							    ...
							    <li class="{{ ($comment->currentPage() == $comment->lastPage()) ? ' disabled' : '' }}">
							        <a href="{{ $comment->url($comment->currentPage()+1) }}" >Next</a>
							    </li>
							</ul>
							@endif
						<?php
