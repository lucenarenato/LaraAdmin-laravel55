	...
	<div class="bg-primary clearfix">
		...
		<div class="col-md-1 actions">
			@la_access("Organizations", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/'.$organization->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'article_title')
						@la_display($module, 'article_content')
